cmd_arch/arm64/boot/dts/qcom/dumpling-v2.1-dvt.dtb := mkdir -p arch/arm64/boot/dts/qcom/ ; clang -E -Wp,-MD,arch/arm64/boot/dts/qcom/.dumpling-v2.1-dvt.dtb.d.pre.tmp -nostdinc -I../arch/arm64/boot/dts -I../arch/arm64/boot/dts/include -I../drivers/of/testcase-data -undef -D__DTS__ -x assembler-with-cpp -o arch/arm64/boot/dts/qcom/.dumpling-v2.1-dvt.dtb.dts.tmp ../arch/arm64/boot/dts/qcom/dumpling-v2.1-dvt.dts ; ./scripts/dtc/dtc -O dtb -o arch/arm64/boot/dts/qcom/dumpling-v2.1-dvt.dtb -b 0 -i ../arch/arm64/boot/dts/qcom/ -Wno-unit_address_vs_reg -d arch/arm64/boot/dts/qcom/.dumpling-v2.1-dvt.dtb.d.dtc.tmp arch/arm64/boot/dts/qcom/.dumpling-v2.1-dvt.dtb.dts.tmp ; cat arch/arm64/boot/dts/qcom/.dumpling-v2.1-dvt.dtb.d.pre.tmp arch/arm64/boot/dts/qcom/.dumpling-v2.1-dvt.dtb.d.dtc.tmp > arch/arm64/boot/dts/qcom/.dumpling-v2.1-dvt.dtb.d

source_arch/arm64/boot/dts/qcom/dumpling-v2.1-dvt.dtb := ../arch/arm64/boot/dts/qcom/dumpling-v2.1-dvt.dts

deps_arch/arm64/boot/dts/qcom/dumpling-v2.1-dvt.dtb := \
  ...
  ../arch/arm64/boot/dts/qcom/dumpling.dtsi \
  ../arch/arm64/boot/dts/qcom/pxlw-iris-settings.dtsi \
  ../arch/arm64/boot/dts/qcom/dumpling-dvt.dtsi \
  ../arch/arm64/boot/dts/qcom/dsi-panel-samsung_s6e3fa3_1080p_cmd.dtsi \
  ../arch/arm64/boot/dts/qcom/dsi-panel-samsung_s6e3fa3_1080p_video.dtsi \
  ...
  ../arch/arm64/boot/dts/qcom/dsi-panel-samsung_s6e3fc1_cmd.dtsi \

arch/arm64/boot/dts/qcom/dumpling-v2.1-dvt.dtb: $(deps_arch/arm64/boot/dts/qcom/dumpling-v2.1-dvt.dtb)
