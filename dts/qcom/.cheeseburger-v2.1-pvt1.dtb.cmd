cmd_arch/arm64/boot/dts/qcom/cheeseburger-v2.1-pvt1.dtb := mkdir -p arch/arm64/boot/dts/qcom/ ; clang -E -Wp,-MD,arch/arm64/boot/dts/qcom/.cheeseburger-v2.1-pvt1.dtb.d.pre.tmp -nostdinc -I../arch/arm64/boot/dts -I../arch/arm64/boot/dts/include -I../drivers/of/testcase-data -undef -D__DTS__ -x assembler-with-cpp -o arch/arm64/boot/dts/qcom/.cheeseburger-v2.1-pvt1.dtb.dts.tmp ../arch/arm64/boot/dts/qcom/cheeseburger-v2.1-pvt1.dts ; ./scripts/dtc/dtc -O dtb -o arch/arm64/boot/dts/qcom/cheeseburger-v2.1-pvt1.dtb -b 0 -i ../arch/arm64/boot/dts/qcom/ -Wno-unit_address_vs_reg -d arch/arm64/boot/dts/qcom/.cheeseburger-v2.1-pvt1.dtb.d.dtc.tmp arch/arm64/boot/dts/qcom/.cheeseburger-v2.1-pvt1.dtb.dts.tmp ; cat arch/arm64/boot/dts/qcom/.cheeseburger-v2.1-pvt1.dtb.d.pre.tmp arch/arm64/boot/dts/qcom/.cheeseburger-v2.1-pvt1.dtb.d.dtc.tmp > arch/arm64/boot/dts/qcom/.cheeseburger-v2.1-pvt1.dtb.d

source_arch/arm64/boot/dts/qcom/cheeseburger-v2.1-pvt1.dtb := ../arch/arm64/boot/dts/qcom/cheeseburger-v2.1-pvt1.dts

deps_arch/arm64/boot/dts/qcom/cheeseburger-v2.1-pvt1.dtb := \
  ...
  ../arch/arm64/boot/dts/qcom/cheeseburger-pvt1.dtsi \
...
arch/arm64/boot/dts/qcom/cheeseburger-v2.1-pvt1.dtb: $(deps_arch/arm64/boot/dts/qcom/cheeseburger-v2.1-pvt1.dtb)
