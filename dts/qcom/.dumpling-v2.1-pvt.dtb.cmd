cmd_arch/arm64/boot/dts/qcom/dumpling-v2.1-pvt.dtb := mkdir -p arch/arm64/boot/dts/qcom/ ; clang -E -Wp,-MD,arch/arm64/boot/dts/qcom/.dumpling-v2.1-pvt.dtb.d.pre.tmp -nostdinc -I../arch/arm64/boot/dts -I../arch/arm64/boot/dts/include -I../drivers/of/testcase-data -undef -D__DTS__ -x assembler-with-cpp -o arch/arm64/boot/dts/qcom/.dumpling-v2.1-pvt.dtb.dts.tmp ../arch/arm64/boot/dts/qcom/dumpling-v2.1-pvt.dts ; ./scripts/dtc/dtc -O dtb -o arch/arm64/boot/dts/qcom/dumpling-v2.1-pvt.dtb -b 0 -i ../arch/arm64/boot/dts/qcom/ -Wno-unit_address_vs_reg -d arch/arm64/boot/dts/qcom/.dumpling-v2.1-pvt.dtb.d.dtc.tmp arch/arm64/boot/dts/qcom/.dumpling-v2.1-pvt.dtb.dts.tmp ; cat arch/arm64/boot/dts/qcom/.dumpling-v2.1-pvt.dtb.d.pre.tmp arch/arm64/boot/dts/qcom/.dumpling-v2.1-pvt.dtb.d.dtc.tmp > arch/arm64/boot/dts/qcom/.dumpling-v2.1-pvt.dtb.d

source_arch/arm64/boot/dts/qcom/dumpling-v2.1-pvt.dtb := ../arch/arm64/boot/dts/qcom/dumpling-v2.1-pvt.dts

deps_arch/arm64/boot/dts/qcom/dumpling-v2.1-pvt.dtb := \
  ...
  ../arch/arm64/boot/dts/qcom/dumpling-pvt.dtsi \
...
arch/arm64/boot/dts/qcom/dumpling-v2.1-pvt.dtb: $(deps_arch/arm64/boot/dts/qcom/dumpling-v2.1-pvt.dtb)
